...
public class ProjectDaoImpl extends HibernateDaoSupport implements ProjectDao {
        ...
        for (Module module : projectClient.getModuleList()) {
            ...
            for (Page page : module.getPageList()) {
                ...
                for (Action action : page.getActionList()) {
                    ...
                    List<Parameter> requestParameterList = sortParemeter(new ArrayList<Parameter>(action.getRequestParameterList()));
                    ...
                    List<Parameter> responseParameterList = sortParemeter(new ArrayList<Parameter>(action.getResponseParameterList()));
     ...
     * @return
     */
    private List<Parameter> sortParemeter(List<Parameter> list) {
